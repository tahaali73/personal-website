    ...
    <div className="w-full py-16 px-4 sm:px-6 lg:px-8 bg-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12 md:mb-16">
          <h2 className="font-manrope font-semibold text-3xl md:text-4xl lg:text-[38px] text-[#333333] mb-4">
            Benefits
          </h2>
          <p className="font-manrope font-normal text-base md:text-lg text-[#4D4D4D] max-w-3xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          {benefits.slice(0, 2).map((benefit, index) => (
            <div 
              key={index}
              className="bg-[#F7F6F3] rounded-2xl p-8 transition-all duration-300 hover:shadow-xl hover:border hover:border-[#5700FF]/20"
            >
              <div className="flex items-start mb-6">
                <div className="w-10 h-10 rounded-full bg-[#5700FF] flex items-center justify-center mr-4">
                  <div className="w-6 h-6 bg-white rounded-full flex items-center justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-[#5700FF]" viewBox="0 0 20 20" fill="currentColor">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                    </svg>
                  </div>
                </div>
                <h3 className="font-manrope font-semibold text-xl md:text-2xl text-[#333333]">
                  {benefit.title}
                </h3>
              </div>
              <p className="font-manrope font-normal text-base md:text-lg text-[#4D4D4D]">
                {benefit.description}
              </p>
            </div>
          ))}
            ...
            {benefits.slice(2, 5).map((benefit, index) => (
              ...
              >
                <div className="flex items-start mb-6">
                  ...
                  <h3 className="font-manrope font-semibold text-xl text-[#333333]">
                    {benefit.title}
                  </h3>
                </div>
