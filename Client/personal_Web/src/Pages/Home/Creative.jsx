  ...
  const skills = [
    {
      ...
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="54" height="54" viewBox="0 0 24 24" fill="#5700FF">
    ...
    },
    {
      ...
      description: "Expertise in optimizing websites for mobile devices, ensuring fast loading times and excellent user experience.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="54" height="54" viewBox="0 0 24 24" fill="#5700FF">
          <path d="M17 1.01L7 1c-1.1 0-2 .9-2 2v18c0 1.1.9 2 2 2h10c1.1 0 2-.9 2-2V3c0-1.1-.9-1.99-2-1.99zM17 19H7V5h10v14z"/>
    ...
    <div className="w-full py-16 px-4 sm:px-6 lg:px-8 bg-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          <h2 className="font-manrope font-semibold text-3xl sm:text-4xl md:text-[38px] text-[#333333] mb-4">
            Creative Skills
          </h2>
          <p className="font-manrope font-normal text-base sm:text-lg md:text-xl text-[#4D4D4D] max-w-3xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-12">
          {skills.map((skill, index) => (
            <div 
              key={index}
              className="group bg-white rounded-xl p-6 md:p-8 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100 hover:border-[#5700FF]"
            >
              <div className="flex flex-col items-center">
                {/* Icon with animated background */}
                <div className="mb-6 p-4 bg-[#F5F3F0] rounded-full group-hover:bg-[#5700FF] transition-colors duration-300">
                ...
                <div className="text-center">
                  <h3 className="font-manrope font-semibold text-xl md:text-[20px] text-[#333333] mb-3 group-hover:text-[#5700FF] transition-colors">
                    {skill.title}
                  </h3>
                  <p className="font-manrope font-normal text-sm md:text-base text-[#4D4D4D]">
                    {skill.description}
                  </p>
                </div>
              </div>
