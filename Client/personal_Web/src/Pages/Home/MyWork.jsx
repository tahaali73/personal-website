    ...
    <div className="w-full py-16 px-4 sm:px-6 lg:px-8 bg-white">
      <div className="max-w-7xl mx-auto">
          ...
          >
            <div className="flex space-x-6 min-w-max px-4">
              {projects.map((project, index) => (
                <div 
                  key={index}
                  className="group bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:border-[#5700FF]/30 w-[300px] sm:w-[350px] flex-shrink-0"
                >
                  <div className="p-6">
                    <h3 className="font-manrope font-medium text-lg md:text-xl text-[#333333] mb-4 group-hover:text-[#5700FF] transition-colors">
                      {project.title}
                    </h3>
                    ...
                    <div className="grid grid-cols-4 gap-2">
                      {project.thumbnails.map((thumbnail, thumbIndex) => (
                        <div 
                          key={thumbIndex}
                          className="bg-gray-100 rounded-md aspect-square overflow-hidden"
                        >
                          <img 
                            src={thumbnail} 
        ...
        <div className="flex justify-center">
          <button className="font-manrope font-medium text-sm sm:text-base text-white bg-[#5700FF] hover:bg-[#4500cc] transition-colors flex items-center justify-center py-3 px-8 rounded-lg shadow-md hover:shadow-lg">
